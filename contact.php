...
<nav class="navbar navbar-inverse">
    ...
    <p class="hoofdtype1"> Heeft u een vraag?</p>
<div class="formulier">
    <head>
    ...
    <form name="contactform" method="post" action="mail2.php">
        <table width="450px">
            <tr>
            ...
            <tr>
                <td valign="top" class="hoofdtype1">
                    <label for="concept">De vraag</label>
                </td>
                <td valign="top">
            ...
            <tr>
                <td valign="top" class="hoofdtype1">
                    <label for="comments">Wat is het probleem?</label>
                </td>
                <td valign="top">
